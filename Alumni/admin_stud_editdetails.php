...
if (isset($_GET['search'])) {
    ...
    $query = "SELECT * FROM student natural join sdetails WHERE name LIKE '%$search%' OR email LIKE '%$search%' or cpi like '%$search%'";
} else {
    $query = "SELECT * FROM student natural join sdetails";
}
...
while ($row = mysqli_fetch_assoc($result)) {
    echo '<tr>';
    echo '<td><a href="studEdit.php?id=' . $row['email'] . '">' . $row['name'] . '</a></td>';
    echo '<td>' . $row['cpi'] . '</td>';
