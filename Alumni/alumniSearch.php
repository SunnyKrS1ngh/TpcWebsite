...
if (isset($_GET['search'])) {
    ...
    $query = "SELECT * FROM alumni c NATURAL JOIN alumdet cr WHERE c.name LIKE '%$search%' OR c.email LIKE '%$search%'";
} else {
    $query = "SELECT * FROM alumni c natural join alumdet cr";
}
...
while ($row = mysqli_fetch_assoc($result)) {
    echo '<tr>';
   echo '<td><a href="/psystem/admin/alumEdit.php?id=' . $row['email'] . '">' . $row['name'] . '</a></td>';
